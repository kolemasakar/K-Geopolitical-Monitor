...
Status: `AUTHORITATIVE_POINTER / PHASE_23_APPROVED / P23_2_VALIDATED_WITH_ZERO_UNDERLYING_ORIGIN_RESOLUTION / P23_3_READY`
...
Current position:
`PHASE_23_P23_2_UNDERLYING_ORIGIN_PROVENANCE_RESOLUTION_VALIDATED`

Next gate:
`P23_3_CORROBORATION_EVIDENCE_RELATION_POPULATION_VALIDATED`
