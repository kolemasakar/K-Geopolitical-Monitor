...
def test_p22_5_does_not_promote_legacy_truth_and_opens_only_p22_6():
    ...
    assert s["roadmap"]["state_sync_version"]=="4.56"
    assert s["roadmap"]["current_position"]=="PHASE_22_P22_5_SEMANTIC_CORPUS_VERIFICATION_OBSERVATION_VALIDATED"
    assert s["phase22"]["p22_5_state"]=="VALIDATED_WITH_ALL_CLAIMS_DETECTED_AND_UNDERLYING_ORIGIN_UNRESOLVED"
    assert s["phase22"]["next_gate"]=="P22_6_DOWNSTREAM_INTELLIGENCE_IMPACT_VALIDATED"
