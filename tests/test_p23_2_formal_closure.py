...
def test_p23_2_canonical_state_and_evidence_converge():
    ...
    p23_2 = state["phase23_p23_2"]
    assert p23_2["state"] == "VALIDATED_WITH_ZERO_UNDERLYING_ORIGIN_RESOLUTION"
    assert p23_2["gate"] == "P23_2_UNDERLYING_ORIGIN_PROVENANCE_RESOLUTION_VALIDATED"
    assert p23_2["next_gate"] == "P23_3_CORROBORATION_EVIDENCE_RELATION_POPULATION_VALIDATED"
