...
def test_post_phase21_strategic_audit_remains_historical_after_phase22_approval():
    ...
    assert x["decision_state"] in {"ROADMAP_DECISION_REQUIRED", "OWNER_APPROVED_PHASE_22"}
    ...
    if x["decision_state"] == "OWNER_APPROVED_PHASE_22":
