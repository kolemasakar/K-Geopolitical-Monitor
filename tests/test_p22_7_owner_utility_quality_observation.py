...
def test_p22_7_state_opens_only_phase22_acceptance():
    ...
    assert s["roadmap"]["current_position"] == "PHASE_22_P22_7_OWNER_UTILITY_QUALITY_OBSERVATION_VALIDATED"
    assert s["phase22"]["p22_7_state"] == "VALIDATED_WITH_NO_OWNER_UTILITY_FEEDBACK_OBSERVED"
    assert s["phase22"]["next_gate"] == "PHASE_22_OPERATIONAL_EVIDENCE_HIGH_PRIORITY_COVERAGE_VALIDATED"
