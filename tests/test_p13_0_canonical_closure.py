...
def test_p13_0_provenance_independence_evidence_and_contradiction_contracts_remain():
    plan = PLAN.read_text(encoding="utf-8")
    for text in (
...
def test_p13_0_separates_extraction_truth_and_coverage_confidence():
    plan = PLAN.read_text(encoding="utf-8").lower()
...
def test_p13_0_historical_gate_survives_sequential_progress():
