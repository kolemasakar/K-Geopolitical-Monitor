...
def test_p22_5_gap_does_not_promote_legacy_state_or_open_p22_6():
    ...
    assert s["phase22"]["p22_5_state"]=="BLOCKED_ON_CANONICAL_SEMANTIC_INGESTION_GAP"
    assert s["phase22"]["next_gate"]=="P22_5_CANONICAL_SEMANTIC_INGESTION_BRIDGE_IMPLEMENTATION"
